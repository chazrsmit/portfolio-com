        ...
        <>
            <section className="home d-flex flex-column">
                ...
                <div className="titres">
                    <h2>
                        <span
                            className={`${element === "socialmedia" ? 'selected' : ''}`}
                        ...
                        <span
                            className={`${element === "posters" ? 'selected' : ''}`}
                        ...
                        <span
                            className={`${element === "textes" ? 'selected' : ''}`}
                            onClick={() => handleClick("textes")}
                        >
                            textes
                        </span>,{' '}

                        <span
                            className={`${element === "newsletters" ? 'selected' : ''}`}
                        ...
                        <span
                            className={`${element === "dossiers" ? 'selected' : ''}`}
                ...
                <AnimatePresence mode="wait">
                    ...
                    {isOpened ?
                                ...
                                <div className="textes">
                                    ...
                                    <div>
                                        ...
                                        {selectedText === "four" &&
                                            <div>
                                                <p>
                                                    TURBE - Urbanisme Émotionnel is an experiment. An experiment to cut through the city with ever-changing eyes, changing ears, words, of one, of many, of many more to come.<br/><br/>
                                    ...
                                    <div>
                                        ...
                                        {selectedText === "five" &&
                                            <div>
                                                <p>
                                                    <b><i>Reality: transfiguration of the common place</i></b>
                                                    <br/><br/>
                                    ...
                                    <div>
                                        ...
                                        {selectedText === "six" &&
                                            <div>
                                                <p>
                                                    <b><i>Dimanche: turn off the lights so I can’t see</i></b>
                                                    <br/><br/>
                                    ...
                                    <div>
                                        ...
                                        {selectedText === "seven" &&
                                            <div className="pb-5">
                                                <p>
                                                    <b><i>Speak no evil : L’art du savoir-dire</i></b>
                                                    <br/><br/>
                        ...
                        <div className="nb2">
                            <h4>
                                Ce site regroupe une sélection d'éléments (principalement) d'ordre promotionnel, certains aisément retrouvés, d'autres perdus dans les méandres digitaux d'anciens outils numériques de travail ou adresses email désormais inaccessibles.
                            </h4>
                        </div>
